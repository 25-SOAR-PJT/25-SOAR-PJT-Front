package my_app.soar.CalendarPage
...
import my_app.soar.databinding.ItemCalendarScheduleBinding
...
class CalendarScheduleAdapter(
...
) : ListAdapter<BookmarkedPolicy, CalendarScheduleAdapter.ScheduleViewHolder>(DiffCallback) {
    ...
    override fun onBindViewHolder(holder: ScheduleViewHolder, position: Int) {
        ...
        val checkboxDrawable =
            if (policy.applied) R.drawable.icon_checkbox_checked else R.drawable.icon_checkbox
