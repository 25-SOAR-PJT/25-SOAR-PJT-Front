package my_app.soar.DetailPage

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import my_app.soar.ArchivingPage.Event
import my_app.soar.Network.detail.DetailRepository
...
class DetailViewModel : ViewModel() {
    ...
    fun loadBookmarkStatus(policyId: String) {
        ...
        if (my_app.soar.Network.TokenManager.getAccessToken().isNullOrEmpty()) {
