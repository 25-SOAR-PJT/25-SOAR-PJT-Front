...
import my_app.soar.Network.RetrofitClient.apiService
import my_app.soar.Network.TokenManager
import my_app.soar.R
import my_app.soar.databinding.ActivityDetailPageBinding
...
class DetailPageActivity : AppCompatActivity() {
    ...
    private fun updateUIWithStepDetail(stepDetail: my_app.soar.Network.detail.PolicyStepDetail) {
