...
import my_app.soar.ArchivingPage.ArchivingFragment
import my_app.soar.CalendarPage.CalendarFragment
import my_app.soar.ExplorePage.ExploreFragment
import my_app.soar.HomePage.HomeFragment
import my_app.soar.MyPage.MypageFragment
import my_app.soar.Network.RecentViewManager
import my_app.soar.Network.TokenManager
import my_app.soar.databinding.ActivityMainBinding
        ...
        if (shouldOpenPersonalBiz) {
            ...
            binding.container.post {
                ...
                if (!accessToken.isNullOrEmpty()) {
                    startActivity(Intent(this, my_app.soar.ExplorePage.PersonalBizActivity::class.java))
