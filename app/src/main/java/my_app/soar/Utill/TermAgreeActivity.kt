package my_app.soar.Utill // 실제 PolicyActivity의 패키지 경로
...
import my_app.soar.databinding.ActivityTermDefaultBinding // 사용하는 바인딩 클래스
import androidx.activity.viewModels // ✨ 1. viewModels import
import my_app.soar.CurationSequencePage.CurationSequenceActivity
import my_app.soar.util.showBlockingToast // ✨ 2. 커스텀 토스트 import
