// my_app.soar.ExplorePage/SearchActivity.kt
...
import my_app.soar.databinding.ActivitySearchBinding
...
class SearchActivity : AppCompatActivity(), ExploreAdapter.OnItemClickListener {
    ...
    override fun onBookmarkClick(policy: YouthPolicy) {
        val accessToken = my_app.soar.Network.TokenManager.getAccessToken()
